...
insert  into `users`(`id`,`name`,`email`,`email_verified_at`,`password`,`remember_token`,`created_at`,`updated_at`) values (1,'Usuario de Test.','test@test.com',NULL,'$2y$10$i8/om/7CD5V3zbbckwCy6ewQIfbm0QK.GFkMBSITqj09QABVvWLwq',NULL,'2023-03-31 20:39:25','2023-03-31 22:41:11');
